...
// Constructor
INterface::INterface() : ventana(sf::VideoMode(800, 600), "Pantalla de Carga"), progreso(0.0f) {
...
void INterface::procesarEventos() {
    sf::Event evento;
